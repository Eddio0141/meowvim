...
return {
  ...
  keys = {
    ...
    { "<leader>ta<space>", function() require("telescope.builtin").find_files({ hidden = true }) end },
    { "<leader>ta/",       function() require("telescope.builtin").live_grep({ additional_args = { "--hidden" } }) end }
  },
  after = function()
